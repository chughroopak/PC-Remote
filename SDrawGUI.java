...
public class SDrawGUI extends JFrame{
    ...
    public SDrawGUI(String server_ip) {
        initComponents();
          try{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      try{ 
          FileTransfer ft=new FileTransfer(server_ip);
          ft.setVisible(true);
      }catch(Exception e){
          e.printStackTrace();
      }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SDrawGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
